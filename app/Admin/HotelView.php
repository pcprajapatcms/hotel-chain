								...
								<div class="flex flex-col items-center p-4 bg-gray-50 border border-solid border-gray-400 rounded">
									<div class="mb-3 text-center">
										...
										<?php if ( $qr_code_data_uri ) : ?>
											<img src="<?php echo esc_attr( $qr_code_data_uri ); ?>" alt="<?php esc_attr_e( 'Registration QR Code', 'hotel-chain' ); ?>" class="mx-auto border-2 border-solid border-gray-300 rounded p-2 bg-white mb-4" style="max-width: 250px; height: auto;" />
											<a href="<?php echo esc_url( admin_url( 'admin-post.php?action=hotel_chain_download_qr&url=' . rawurlencode( $detail_reg ) . '&hotel=' . rawurlencode( $detail_name ) . '&_wpnonce=' . wp_create_nonce( 'download_qr_code' ) ) ); ?>" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-800 text-white hover:text-white font-medium rounded-md shadow-sm hover:shadow-md transition-all duration-200 text-sm mx-auto">
