...
class Assets implements ServiceProviderInterface {
	...
	public function enqueue_admin( string $hook ): void {
		...
		if ( ! in_array( $page, array( 'hotel-chain-accounts', 'hotel-details', 'hotel-video-upload', 'hotel-video-library', 'hotel-video-requests', 'hotel-video-taxonomy', 'hotel-profile' ), true ) ) {
			return;
		}
