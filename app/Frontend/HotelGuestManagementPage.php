				...
				<div class="space-y-6">
					...
					<div class="bg-white rounded p-4 border border-solid border-gray-400">
						<form method="get" action="" class="flex items-center justify-between gap-4 flex-wrap">
							...
							<?php endif; ?>
							<a href="<?php echo esc_url( $export_url ); ?>" class="px-4 py-2 bg-green-200 border-2 border-green-400 rounded text-green-900 flex items-center gap-2 w-full md:w-auto justify-center hover:bg-green-300 transition-all duration-300 cursor-pointer hover:text-green-900">
